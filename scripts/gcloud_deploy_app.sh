...
BACKEND_ENV+=",GUARD_LLM_ENABLED=${GUARD_LLM_ENABLED},GUARD_LLM_URL=${GUARD_URL},GUARD_LLM_AUTH=${GUARD_LLM_AUTH},GUARD_LLM_MODEL=llama-guard3:1b,GUARD_LLM_TIMEOUT=20"
BACKEND_ENV+=",CHART_CLIP_MODEL=openai/clip-vit-base-patch32,CHART_CLIP_THRESHOLD=0.5,CHART_MIN_DATA_DIGITS=2,CHART_BLOCK_THRESHOLD=0.3"
